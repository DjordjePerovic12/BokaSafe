...
import llc.bokadev.bokabayseatrafficapp.presentation.more.safety_hub.SafetyHubScreen
import llc.bokadev.bokabayseatrafficapp.presentation.more.safety_hub.SafetyHubViewModel

@RequiresApi(Build.VERSION_CODES.O)
@SuppressLint("RememberReturnType")
@OptIn(ExperimentalAnimationApi::class)
fun NavGraphBuilder.safetyHubScreenComposable(
    navController: NavController,
    showSnackBar: (message: String) -> Unit,
    launchIntent:  (intent: Intent) -> Unit
) {
    composable(route = Screen.SafetyHubScreen.route,
        ...
        val viewModel = hiltViewModel<SafetyHubViewModel>()
        SafetyHubScreen(
            viewModel = viewModel,
