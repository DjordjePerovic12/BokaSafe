...
class DataStoreImplementation @Inject constructor(@ApplicationContext val context: Context) :
    ...
    companion object {
        ...
        val SHOULD_SHOW_CURSOR_INSTRUCTIONS =
            booleanPreferencesKey("SHOULD_SHOW_CURSOR_INSTRUCTIONS")
    ...
    override suspend fun getShouldShowCursorInstruction() =
